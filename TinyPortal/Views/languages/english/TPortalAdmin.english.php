...
$txt['tp-imageproxycheckdesc'] = 'This defaults to ON and is only effective when ELK Image Proxy is Enabled. Deactivating this option may resolve conflicts with certain Mods, but will deactivate the image proxy for http images in PHP articles and HTML blocks.';
...
$txt['tp-allowguestsdesc'] = 'Allow guests and members to see forum-topics on the frontpage, even if they are not allowed to see the boards themselves? [Yes]: users will get to see it, regardless of your ELK setting. [No]: users will \'not\' get to see it, regardless of your ELK setting.';
...
$txt['tp-moveblockright']   = 'Move to the right panel';
$txt['tp-moveblockleft']    = 'Move to the left panel';
$txt['tp-moveblocktop']     = 'Move to top panel';
$txt['tp-moveblockcenter']  = 'Move to upper panel';
$txt['tp-moveblockfront']   = 'Move to front panel';
$txt['tp-moveblocklower']   = 'Move to lower panel';
$txt['tp-moveblockbottom']  = 'Move to bottom panel';
